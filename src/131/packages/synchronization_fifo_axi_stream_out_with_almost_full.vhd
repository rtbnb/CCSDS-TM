----------------------------------------------------------------
-- File : synchronization_fifo_axi_stream_out_with_almost_full.vhd
-- Created : 06.05.2026
-- Author : Lukas Reil 
...
entity synchronization_fifo_axi_stream_out_with_almost_full is
    generic (
...
end entity synchronization_fifo_axi_stream_out_with_almost_full;

architecture behavioral of synchronization_fifo_axi_stream_out_with_almost_full is
...
begin
    ...
    almost_full_s <= '1' when ((wr_ptr_r + 2) mod DEPTH) = rd_ptr_r else '0';
    almost_full_o <= almost_full_s or full_s;
