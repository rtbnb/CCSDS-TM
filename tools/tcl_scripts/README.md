...
- Create Post-Synthesis Project
- Add top_level_synth.dcp to Sources
- Add Simulation file from src/sim/top_sim.vhd
- Run Simulation and select top_sim as sim file
- Verify, that in the first 10ns Out1 is 0 and after 10ns Out1 is 1