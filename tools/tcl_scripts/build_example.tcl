# build.tcl
source [file normalize [file join [file dirname [info script]] create_project_example.tcl]]
...
set BUILD_DIR [file normalize [file join $PROJ_ROOT build/example]]
...
# change CWD so Vivado writes .Xil, .runs, default outputs into build/example/
cd $BUILD_DIR
